...
// Taken from https://github.com/DarthAffe/RGB.NET
...
namespace Corsair.Native
{
    public class CUESDK
    {
        ...
        public static void LoadCUESDK()
        {
            ...
            if (arch == "AMD64")
            {
                possiblePathList.Add("x64/CUESDK.x64_2015.dll");
            }
            else
            {
                possiblePathList.Add("i386/CUESDK_2017.dll");
            }
        ...
        /// </summary>
        public static int CorsairGetDeviceCount() => _corsairGetDeviceCountPointer();

        /// <summary>
        /// CUE-SDK: returns information about device at provided index.
        /// </summary>
        public static IntPtr CorsairGetDeviceInfo(int deviceIndex) => _corsairGetDeviceInfoPointer(deviceIndex);
        
        /// <summary>
        /// CUE-SDK: provides list of keyboard or mousepad LEDs with their physical positions.
        /// </summary>
        public static IntPtr CorsairGetLedPositionsByDeviceIndex(int deviceIndex) => _corsairGetLedPositionsByDeviceIndexPointer(deviceIndex);
        ...
        /// </summary>
        public static bool CorsairRequestControl(CorsairAccessMode accessMode) => _corsairRequestControlPointer(accessMode);
        ...
        /// </summary>
        public static CorsairProtocolDetails CorsairPerformProtocolHandshake() => _corsairPerformProtocolHandshakePointer();
